...
(function (global) {
  ...
  /* Legs are free to enter in any order, so rank counts every leg cleared
     rather than an unbroken run from the first. A student who starts at
     Leg 5 because that is what their class is doing still gets credit. */
  ...
  /* Open navigation: any leg, any time. The Checkpoint inside a leg
     still waits for its three lessons — that is a check on the leg's own
